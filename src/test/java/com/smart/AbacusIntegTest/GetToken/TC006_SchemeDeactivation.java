...
public class TC006_SchemeDeactivation extends TestBase{
	
	@Test(dataProvider="schemeDeactdataprovider")
	void deactivateScheme_on_Smart(
			String clnPolCode,
			String userId,
			String anniv
			/*String id*/
		...
		logger.info("::::::: Started TC002_Send_scheme_deactions_to_Smart :::::");		
		...
		Map<String, Object> queryParams = new HashMap<String, Object>();
			...
			queryParams.put("access_token", "53d110932{d1753w44-451773b57g15d14183-44{n8UF0R47GCa9eFD-7803g10n0d06}8034{");
			...
			response = httpRequest.request(Method.PUT,"/schemes/deactivations/1");
	...
	@DataProvider(name="schemeDeactdataprovider")
	String [][]getScheme() throws IOException{
		
		String path ="H:/Afyaplus/AbacusIntegTest/src/test/java/com/smart/AbacusIntegTest/dataprovider/schemedeact.xlsx";
